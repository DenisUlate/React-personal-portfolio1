...
const Nav = () => {
	return (
		<div className='fixed w-full h-[80px] flex  items-center px-4 bg-[var(--bg-transparent-black)] top-0'>
			<div className='lg:w-[1200px] flex justify-between m-auto px-4 py-4 h-full items-center'>
				...
				<ul className='flex text-gray-400 gap-2 item-center md:ml-[4rem] md:text-[14px] lg:text-[1rem] '>
