...
const Home = () => {
  return (
    <section name="Home" className=" h-fit md:h-screen w-full bg-[var(--bg-dark)] mt-20 py-[3rem]">
      <div className="w-full md:max-w-screen-xl flex mx-auto justify-between items-center flex-col md:flex-row px-8 ">
        {/* text */}
        <div className="w-[390px] md:w-[490px] px-2 pb-4 md:pb-0">
